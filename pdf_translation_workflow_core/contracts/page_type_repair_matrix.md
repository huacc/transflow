...
| `sidebar_orientation_fail` | annual report side navigation | rotated_text_draw_mode | layout policy draw_modes, PyMuPDF rotated insertion, source-vs-output crop | rotated source labels remain rotated, not stacked character-by-character |
