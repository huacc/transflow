...
- `docs\业务流程\01_source_pdf_中文回填_详细流程记录.md` is the audit narrative and source-of-truth process record.
...
| `regression\regression_manifest.json` | Regression input manifest for `01_source.pdf` and AIA pages |
