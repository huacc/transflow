...
def run(round_root: Path, output: Path) -> None:
    ...
    required_reports = [
        ...
        reports / "page_profiles.json",
        reports / "layout_plan.raw.json",
        reports / "column_flow_elastic_evidence.json",
        ...
        reports / "repair_patch_application_0002.json",
        reports / "layout_plan.repair0002.json",
        reports / "generation_evidence.repair0002.json",
        reports / "quality_gates.repair0002.json",
        reports / "quality_signals.repair0002.json",
        reports / "visual_adjudication.repair0002.json",
        reports / "repair_loop_0002.json",
        ...
        reports / "decision_artifacts" / "repair_patch_0001.json",
        reports / "repair_acceptance.json",
        reports / "repair_memory_ledger.json",
        reports / "tool_binding_map.json",
        reports / "decision_graph_validation.json",
        reports / "round28_change_ledger.md",
    ...
    required_static = [
        ...
        round_root / "run_round28_contract_case.py",
        round_root / "run_round28_batch.py",
        ...
        round_root / "contracts" / "registry" / "failure_classes.json",
        round_root / "contracts" / "registry" / "repair_atoms.json",
        round_root / "contracts" / "registry" / "repair_families.json",
        round_root / "contracts" / "registry" / "problem_domains.json",
        round_root / "prompts" / "templates" / "S5_materialize_translation.prompt.json",
        round_root / "prompts" / "templates" / "S6_page_type_and_column_flow.prompt.json",
        ...
        round_root / "tools" / "planners" / "classify_pages.py",
        round_root / "tools" / "planners" / "plan_layout.py",
        round_root / "tools" / "planners" / "apply_column_flow_elastic.py",
        ...
        round_root / "tools" / "validators" / "validate_decision_graph.py",
        round_root / "tools" / "validators" / "materialize_round28_artifacts.py",
        round_root / "tools" / "validators" / "build_tool_binding_map.py",
        ...
        round_root / "tools" / "repairs" / "obstacle_aware_reflow.py",
    ]
