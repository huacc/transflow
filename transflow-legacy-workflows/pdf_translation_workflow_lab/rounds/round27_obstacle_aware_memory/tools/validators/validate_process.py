...
def run(round_root: Path, output: Path) -> None:
    ...
    required_reports = [
        ...
        reports / "round27_change_ledger.md",
    ...
    required_static = [
        ...
        round_root / "run_round27_contract_case.py",
        round_root / "run_round27_batch.py",
        ...
        round_root / "tools" / "validators" / "materialize_round27_artifacts.py",
