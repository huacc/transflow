...
KNOWN_BINDINGS = [
    ...
    ("validate_semantic_translations.py", "embedded:run_round27_contract_case.py", "partial"),
    ...
    ("materialize_decision_artifacts.py", "tools/validators/materialize_round27_artifacts.py", "implemented"),
        ...
        bindings.append(
            {
                ...
                "round27_target": target,
                "binding_status": status,
                "notes": "Round25/26 seed bindings were re-evaluated inside round27; global core is read-only.",
            }
        )
    return {
