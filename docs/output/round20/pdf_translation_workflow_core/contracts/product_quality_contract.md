...
| metric_value_hierarchy | `collect_visual_region_metrics.py` role gate using current-run source font hierarchy and generic value tokens | D7 | yes when KPI/metric value regions exist |
